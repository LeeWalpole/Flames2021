...
.nav-bar img { 
    height: calc(var(--nav-height) - 44px)!important; 
...
$logo_jetpack_url = "https://i0.wp.com/".$logo_short_url . "?h=100";
?>
<div id="nav" class="nav">
    <nav id="nav-bar" class="nav-bar">
        <?php if ($logo_url) { ?>
        <a href="<?php echo esc_html(get_home_url()); ?>" class="nav-logo"
            title="<?php echo esc_html(get_bloginfo('name')); ?> Logo">
            <img src="<?php echo esc_attr($logo_jetpack_url); ?>" alt="<?php echo esc_attr(get_bloginfo('name')); ?>" loading="eager">
        </a>
    ...
    <div class="nav-menu bg-black" data-theme="dark">
