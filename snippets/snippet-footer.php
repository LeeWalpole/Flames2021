...
<footer id="footer" class="footer bg-black center" data-theme="dark">
    <?php if( have_rows('site_menu','options') ) : ?>
    <!-- nav-menu-inner allows for overflow / scrolling -->
    <div class="v-padding bg-offblack" data-theme="dark">
        <div id="footer-menu-elements" class="grid w-max margin-auto center nav-menu-elements">
...
?>
    ...
    <div class="bg-black v-padding center">
        <?php if ($logo_url) : ?>
        <figure class="flex footer-logo w-max  margin-auto center">
            <a href="<?php echo esc_html(get_home_url()); ?> center"
        ...
        <small class="copyright bg-black prefade">Copyright © <?php echo date('Y'); ?> |
            ...
            <em class="small prefade"><?php echo esc_attr(get_bloginfo('description')); ?> </em>
        </small>
    ...
    <!-- <a href="https://www.leewalpole.co.uk/" class="credit prefade" target="_blank">
