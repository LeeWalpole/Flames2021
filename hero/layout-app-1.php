...
$cta_1_id = get_field('cta_1_id') ?: "cta_1_id";
if( $cta_1 ): 
    $cta_1_url = $cta_1['url'];
...
$cta_2_id = get_field('cta_2_id') ?: "cta_2_id";
if( $cta_2 ): 
    $cta_2_url = $cta_2['url'];
...
<div class="bg-white row-block hero-block <?php echo esc_attr($hero_feature); ?>" id="hero">
    ...
    $cta_1_target = $cta_1['target'] ? $cta_1['target'] : '_self';  ?>
                <a href="<?php echo esc_attr($cta_1_url); ?>" target="<?php echo esc_attr($cta_1_target); ?>"
                    class="button <?php echo esc_attr($cta_1_id); ?>"><?php echo $cta_1_title; ?></a>
                <?php if( $cta_2 ) :
    $cta_2_url = $cta_2['url'];
    $cta_2_title = $cta_2['title'];
    $cta_2_target = $cta_2['target'] ? $cta_2['target'] : '_self';  ?>
                <a href="<?php echo esc_attr($cta_2_url); ?>" target="<?php echo esc_attr($cta_2_target); ?>"
                    class="button <?php echo esc_attr($cta_2_id); ?>"><?php echo $cta_2_title; ?></a>
                <?php endif; ?>
            </div>
            <?php endif; ?>
