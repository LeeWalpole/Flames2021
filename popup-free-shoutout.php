    ...
    <section id="<?php echo esc_attr($popup_id); ?>" class="modal modal-popup bg-overlay">
                    ...
                    <fieldset id="fieldset_1">
                        ...
                        <div class="grid grid-gap">
                            ...
                            <div class="colspan-6 input-area">
                                <input type="text" placeholder="Your Display Name" class="required" id="name" name="name">
                            </div>
                            <div class="colspan-6 input-area">
                                <i class="fas fa-at"></i>
                        ...
                        <div class="buttons bg-white">
                            <!-- CTA 1 is a Modal  -->
                            <button class="button button-next submit_disabled" type="submit" id="submit">Join Flames - get promoted!</button>
                        </div>

                        <p class="form-terms">
                                <small>By applying, you agree to our <a href="#"> terms of service</a>.</small>
                            </p>
        ...
        <section id="popup-success_message" class="bg-white w-max" data-theme="light">
            <header class="header w-safe bg-white" data-theme="light">
                ...
                <h5 class="hero-headline headline ">We’ll be in touch soon...</h5>
                <div class="lead w-safe ">
                    <p>Make sure you’re following <a href="https://www.instagram.com/thaiflames/" target="_blank">@thaiflames on Instagram</a> so we can verify your account via DM.</p>
                </div>
                <div class="buttons">
                    <!-- CTA 1 is a Link  -->
                    <a href="https://instagram.com/thaiflames/" target="_self" class="button">
                        <i class="fab fa-instagram"></i> Follow @ThaiFlames</a>
                </div>
            </header>
        </section>
    </section>
