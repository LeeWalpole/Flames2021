...
function wpdocs_theme_setup() {
    ...
    add_image_size( 'w-smartphone', 400, false ); // iPhone full
    ...
    add_image_size( 'grid_desktop', 200, 200, true );
    add_image_size( 'grid_smartphone', 200, 200, true );
    add_image_size( 'profile_desktop', 600, false );
    add_image_size( 'profile_smartphone', 400, false );
...
// include_once( 'functions/give-css.php' );