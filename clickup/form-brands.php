        ...
        <form name="google-sheet" class="form" id="popup-form-<?php echo $form_template; ?>">
            ...
            <div class="form-fieldsets">
                <fieldset id="fieldset_1">
                    ...
                    <p class="kicker center">WORK WITH US</p>
                    <header class="header center">

                        <h2>Want to Work with Flames?</h2><br>
                        <small>Use this form or send an email to hello@flames.agency</small>
                    </header>
                    <div class="grid grid-gap">
                        ...
                        <div class="colspan-6 input-area">
                            <input type="text" placeholder="Your Name / Brand" class="required" id="name" name="name">
                        </div>
                        <div class="colspan-6 input-area">
                            <i class="fas fa-at"></i>
