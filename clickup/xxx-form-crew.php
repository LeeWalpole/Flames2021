<?php if( in_array( "promos", get_field( 'clickup_forms' ) ) ) : ?>
<?php include ('form-promos.php'); ?>
<?php /*
    ClickUp List Name: Free Promos
    ClickUp List ID: 181751532
    ClickUp List URL: https://app.clickup.com/25659266/v/b/li/181751532
    Public Form URL: 
    */ ?>
<?php endif; ?>

<?php if( in_array( "crew", get_field( 'clickup_forms' ) ) ) : ?>
<?php /*
    ClickUp List Name: Crew - Photographers and Videographers
    ClickUp List ID: 181751532
    ClickUp List URL: https://app.clickup.com/25659266/v/b/li/181751532
    Public Form URL: 
    */ ?>
<?php include ('form-crew.php'); ?>
<?php endif; ?>
...
<div class="bg-white">
    <h1>Test:<?php echo esc_attr($form_name); ?></h1>

<a href="javascript:void(0);" data-modal="popup-<?php echo esc_attr($form_name); ?>" class="button modal-trigger">Join Flames </a>
</div>


<!-- Submits Data to Google Sheet -->
<section id="popup-<?php echo esc_attr($form_name); ?>" class="modal modal-popup bg-overlay">
    <!-- Background Overlay -->
    <div class="modal__transparent-layer modal-close"></div>
    <div id="popup-inner-<?php echo esc_attr($form_name); ?>" class="popup-form bg-white w-max" data-theme="light">
        <form name="google-sheet" class="form" id="popup-form-<?php echo esc_attr($form_name); ?>">
...
<script>
    document.getElementById('popup-form-<?php echo esc_attr($form_name); ?>').onsubmit = function (e) {
        e.preventDefault();
        ...
        if (!valid.includes(0)) {
            ...
            const scriptURL = '<?php echo get_template_directory_uri(); ?>/clickup/form-'.form_name.'-submit.php'
            let form = document.getElementById('popup-form-<?php echo esc_attr($form_name); ?>');
