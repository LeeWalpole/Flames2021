...
"id": "2g3nt2x",
"custom_id": null,
"name": "'.$name.' - @'.$instagram.' - @'.$dob_formatted.'",
"text_content": null,
"description": "'.$name.' <br>'.$instagram.' <br>'.$country_code.' <br>'.$ip_address.' <br>'.$permalink.' <br>'.$source_url.' <br> Date of Birth'.$dob_formatted.' ",
"assignees": [37791867],
"tags": [
    {
      "name": "'.$form_template.'",
...
"custom_fields": [

    {
        ...
        {
          "id": "a1e26502-53cb-488a-b65c-591fc7398167",
          "value": "'.$dob_formatted.'"
          },      
