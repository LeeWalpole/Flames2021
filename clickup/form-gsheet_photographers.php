...
$gsheet_deployment_id = "AKfycbwX0_QZMm8X3EnUE0eDZCMJyD2Od6ttMHApLiR_WaIgojabGTMuEvCjYW8h-nGo9OeR";
        ...
        <div data-form="popup-form-container-<?php echo $form_template; ?>"
            ...
            <form id="google-sheet" name="google-sheet" class="form">
                ...
                <div class="form-fieldsets">
                    <fieldset id="fieldset_1">
                        ...
                        <header class="header center">
                            ...
                            <h2>Work with Flames Agency</h2><br>
                            <small>Photographers / Videographer Application</small>
                        </header>
                        ...
                        <div class="grid grid-gap">
                            ...
                            <i class="fa-solid fa-link"></i>
                                <input type="text" placeholder="Do you have a website / portfolio" class="required" id="website" name="website">
                            </div>
                ...
                <input type="hidden" id="print_time" name="time"> -->
                    ...
                    <?php if ($form_tags) :?>
                    <input id="form_tags" name="form_tags" type="hidden" value="<?php echo $form_tags; ?>">
                    <?php endif; ?>
    ...
    <script>
        document.getElementById('google-sheet').onsubmit = function (e) {
            ...
            if (!valid.includes(0)) {
                ...
                let name = document.getElementById('website');
