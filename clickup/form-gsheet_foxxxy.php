...
$gsheet_deployment_id = "AKfycbz-jpieQjkeGu59ugl7whac8BkxJRvbWSEngnfgtERZsSrLtOa78C_ZO8Gp5QNjHmAHQA";
// https://script.google.com/macros/s/AKfycbx3wanBbkK2VOhnyzKODyerGvxqyFx5AWG6BumOfI93Qq7TrvuZ25zucTa8wcxsOYAW/exec
// https://docs.google.com/spreadsheets/d/1xXx_zIFt81K3P9CryP98dOMhZcINJKgcbkWAsTxh2RM/edit#gid=0
    ...
    <section id="<?php echo $form_trigger; ?>" class="modal modal-popup bg-overlay">
                ...
                <div class="form-fieldsets">
                    <fieldset id="fieldset_1">
                        ...
                        <header class="header center">
                            ...
                            <p>Applications are discreet and your info will not be shared with anyone.</p>
                        </header>
        ...
        <section id="popup-success_message" class="bg-white w-max" data-theme="light">
            <header class="header w-safe bg-white" data-theme="light">
                <h5 class="headline ">You've successfully registered your interest.</h5>
