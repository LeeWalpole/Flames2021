...
<section id="<?php echo $form_trigger; ?>" class="modal modal-popup bg-overlay">
        ...
        <form name="google-sheet" class="form" id="popup-form-<?php echo $form_template; ?>">
            ...
            <div class="form-fieldsets">
                <fieldset id="fieldset_1">
                    ...
                    <?php } elseif (is_page( 1181 )) {  // models  ?>

                    <p class="kicker center">JOIN FLAMES</p>
                    <header class="header center">
                        <h2>Join and get free promos, photoshoots & shoutouts!</h2><br>
                        <small>You must be aged 18+ to apply.</small>
                    </header>
                    ...
                    <div class="buttons bg-white">
                        <!-- CTA 1 is a Modal  -->
                        <button class="button button-next submit_disabled" type="submit" id="submit">Submit form</button>
                    </div>
    ...
    <section id="popup-success_message" class="bg-white w-max" data-theme="light">
        <header class="header w-safe bg-white" data-theme="light">
            ...
            <h5 class="headline ">You‘ve been added to the guest list...</h5>
            ...
            <strong class="kicker ">Great!</strong>
            <h5 class="headline ">We’ll be in touch very soon...</h5>

            <div class="buttons">
                <!-- CTA 1 is a Link  -->
                <a href="mailto:hello@flames.agency" class="button">Get in touch</a>
                <!-- <i class="fab fa-instagram" style="color:white!important;"></i>   -->
                <a href="https://instagram.com/thaiflames/" class="button">Follow @ThaiFlames</a>
            </div>
